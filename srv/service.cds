using my.report from '../db/schema';

service PackingSiteReportService {
    entity PackingSiteReports as projection on report.PackingSiteReport;
}
...
// using {my.report  as my} from '../db/schema';
